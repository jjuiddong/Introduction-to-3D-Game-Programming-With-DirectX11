...
#pragma region SubdivisionEffect
SubdivisionEffect::SubdivisionEffect(ID3D11Device* device, const std::wstring& filename)
	: Effect(device, filename)
{
	Light3Tech    = mFX->GetTechniqueByName("Light3");
	Light3TexTech = mFX->GetTechniqueByName("Light3Tex");
...
SubdivisionEffect::~SubdivisionEffect()
{
}
#pragma endregion
...
SubdivisionEffect* Effects::SubdivisionFX = 0;

void Effects::InitAll(ID3D11Device* device)
{
	BasicFX = new BasicEffect(device, L"FX/Basic.fxo");
	SubdivisionFX = new SubdivisionEffect(device, L"FX/Subdivision.fxo");
}
